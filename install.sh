...
cp ./usr/share/applications/openvpn3-manager-applet.desktop
cp ./usr/share/openvpn3-manager-applet/application_logo.png
cp ./usr/share/openvpn3-manager-applet/run.py
